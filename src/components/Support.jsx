                ...
                <div className='grid grid-cols-1 lg:grid-cols-3 relative gap-x-8 gap-y-16 px-6 py-12 sm:pt-20 text-black'>
                    <div className='bg-white rounded-xl shadow-2xl'>
                        <div className='p-8'>
                            ...
                            <p className='text-gray-600 text-xl'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Delectus nostrum eius omnis sint quo iure, distinctio veniam quia mollitia fugiat voluptate excepturi labore veritatis ipsa atque voluptatem id ab maiores?</p>
                        </div>
